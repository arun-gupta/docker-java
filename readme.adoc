...
+
. Right-click on the image ending with ``wildfly:latest'' and click on the green arrow in the tab with mouse hover text as ``Create Container''. This will show the following wizard:
+
