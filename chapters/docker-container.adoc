...
[source, text]
----
docker pull dockerlab:5000/wildfly
----
...
dockerlab:5000/wildfly  latest  2ac466861ca1   10 weeks ago  951.3 MB
----
...
[source, text]
----
docker run -it dockerlab:5000/wildfly
----
...
[source, text]
----
docker run -it -p 8080:8080 dockerlab:5000/wildfly
----
...
[source, text]
----
docker run -P -d dockerlab:5000/wildfly /opt/jboss/wildfly/bin/standalone.sh -b 0.0.0.0 -bmanagement 0.0.0.0
----
