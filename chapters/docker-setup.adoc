...
. Download Kubernetes (1.0.0 Candidate Two) from 
ifdef::classroom[http://classroom.example.com:8082/downloads/kubernetes.tar.gz]
ifdef::public[https://github.com/GoogleCloudPlatform/kubernetes/releases/download/v1.0.0/kubernetes.tar.gz]
...
#### JBoss Developer Studio 9 - Beta 1
...
ifdef::public[]
http://tools.jboss.org/downloads/devstudio/mars/9.0.0.Beta1.html[9.0.0 Beta 1]
